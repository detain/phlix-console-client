...
final class AdminClientTest extends TestCase
{
    ...
    public function testProfileSchedulesFetchesTheScheduleList(): void
    {
        $transport = (new FakeTransport())->json(200, [
            'schedules' => [
        ...
        self::assertSame('Weekday Evenings', $schedules[0]->name);
        self::assertSame(['mon', 'tue', 'wed', 'thu', 'fri'], $schedules[0]->daysOfWeek);
    ...
    public function testCreateProfileSchedulePostsAndReturnsMessage(): void
    {
        ...
        self::assertSame('18:00:00', $body['start_time']);
        self::assertSame('22:00:00', $body['end_time']);
        self::assertSame(['mon', 'tue', 'wed', 'thu', 'fri'], $body['days_of_week']);
        self::assertTrue($body['is_active']);
    }

    public function testDeleteProfileScheduleSendsDeleteAndReturnsMessage(): void
    {
    ...
    public function testProfileTagsFetchesTheTagList(): void
    {
        $transport = (new FakeTransport())->json(200, [
            'tags' => [
    ...
    public function testProfileStreamLimitsFetchesStreamLimits(): void
    {
        $transport = (new FakeTransport())->json(200, [
    ...
    public function testUpdateProfileStreamLimitsPutsNewLimits(): void
    {
        ...
        self::assertSame(2000, $body['max_total_bandwidth_kbps']);
    }

    public function testUpdateProfileStreamLimitsOmitsNullBandwidth(): void
    {
