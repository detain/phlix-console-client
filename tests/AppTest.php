...
final class AppTest extends TestCase
{
    ...
    public function testCtrlKOpensThePaletteWithStaticActionsAndFetchesLibraries(): void
    {
        ...
        self::assertSame(['Search', 'Home', 'Settings', 'Stats', 'Watch History', 'Favorites', 'Photos', 'Playlists', 'Servers', 'Shared With Me', 'Invite Links', 'Federation Shares', 'Show metrics', 'Log out', 'Quit'], $labels);
    }
