 ...
 * phlix-server f9a237d2). The expected set comes from the SERVER side only —
...
final class ServerRouteManifestGateTest extends TestCase
{
    ...
    private const EXPECTED_MD5 = '0dac9e69b036779011824057caf509db';

    private const EXPECTED_SERVER_SHA = 'f9a237d2a2213465c48723833be618724c4a7d29';
    ...
    public function testVendoredManifestIsTheContractsArtifactByteIdentical(): void
    {
        ...
        self::assertSame(self::EXPECTED_MD5, md5($raw), self::GATE_ID . ': vendored manifest drifted from contracts@9ddbed5');
