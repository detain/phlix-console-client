 ...
 * scroll offset. Immutable; the owning screen moves the cursor and swaps in
 * loaded posters. Phase 1's app-local rail (the planned `sugar-gallery` Rail
 * promotes this upstream later).
 */
