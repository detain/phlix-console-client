 ...
 * {@see \Phlix\Console\Audio\MusicSession}. Carries the album + the track's index
 * (so the session knows what is playing and can auto-advance) and the absolute,
 * server-resolved stream URL handed verbatim to ffplay/mpv.
 */
